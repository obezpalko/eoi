...
- **Casco antiguo**: Zona histórica de una ciudad.
- **Ciudad cosmopolita**: Ciudad con mezcla de culturas y mucha actividad.
- **Clima templado**: Clima que no es ni muy frío ni muy caluroso.
- **Vida nocturna**: Actividades de ocio durante la noche (bares, discotecas).

### Objetivos y Personas
| Palabra | Definición | Ejemplo |
| :--- | :--- | :--- |
| **Cajón** | Espacio para guardar cosas en un mueble. | Mis calcetines están en el **cajón**. |
| **Cojín** | Almohada pequeña para el sofá o silla. | Pon un **cojín** en la silla para estar más cómodo. |
| **Orgullo** | Sentimiento de satisfacción propia. | Siento mucho **orgullo** por mi hijo. |
| **Turista** | Persona que visita un lugar por placer. | En verano llegan muchos **turistas**. |

### Otros términos
- **Además**: También, a mayores.
- **Arriba / Abajo**: Adverbios de lugar.
- **Diurno / Nocturno**: Que ocurre durante el día / la noche.
