...
---
# 
![[attachments/20260202.pdf]]

## Contrarios 1 (46)


| Preposición de lugar | Contrario         |
| -------------------- | ----------------- |
...
| :--- | :--- | :--- |
| de lana | woolen | шерстяной |
| de algodón | cotton | хлопковый |
| de nailon | nylon | нейлоновый |
| de piel / de cuero | leather | кожаный |
| de licra | lycra / spandex | из ликры |
| de seda | silk | шелковый |
| de lino | linen | льняной |
| de vaquero / denim | denim | джинсовый |
| de terciopelo | velvet | бархатный |
| de encaje | lace | кружевной |
...
| claro | light | светлый |
| oscuro | dark | темный |
| crudo | ecru / off-white | натуральный (цвет сурового полотна) |
| rojo | red | красный |
| rosa | pink | розовый |
| negro | black | черный |
| blanco | white | белый |
| verde | green | зеленый |
| amarillo | yellow | желтый |
| azul | blue | синий / голубой |
| naranja | orange | оранжевый |
| violeta / morado | violet / purple | фиолетовый |
| gris | grey | серый |
| marrón | brown | коричневый |
| beige | beige | бежевый |

---

### Tipo y Detalles (Тип и детали)

| Español | English | Русский |
| :--- | :--- | :--- |
| largo / corto | long / short | длинный / короткий |
| ancho / estrecho | wide (loose) / tight | широкий / узкий (облегающий) |
| de moda / clásico | trendy / classic | модный / классический |
| a rayas | striped | в полоску |
| a cuadros | checked | в клетку |
| de lunares | polka dot | в горошек |
| estampado | patterned / printed | с принтом (узорчатый) |
| liso | plain / solid color | однотонный (гладкий) |
| con bolsillos | with pockets | с карманами |
| con botones | with buttons | на пуговицах |
| con cremallera | with a zipper | на молнии |
| con cordones | with laces | со шнурками |
| con hebilla | with a buckle | с пряжкой |
| de manga larga | long-sleeved | с длинным рукавом |
| de manga corta | short-sleeved | с коротким рукавом |
| sin mangas | sleeveless | без рукавов |
| con escote en V | V-neck | с V-образным вырезом |
| con cuello alto | turtleneck | с высоким воротником |
| de talla única | one size | единого размера |
### Tipos de lluvia en España

| Término                  | Inglés                | Ruso                   | Descripción (en español)                                      |
| :----------------------- | :-------------------- | :--------------------- | :------------------------------------------------------------ |
| **Llover a cántaros**    | To rain cats and dogs | Лить как из ведра      | Llover de forma muy abundante y con mucha fuerza.             |
| **Chubasco**             | Shower                | Ливень (короткий)      | Lluvia corta pero que cae con mucha intensidad.               |
| **Llovizna**             | Drizzle               | Морось                 | Lluvia muy menuda и de poca intensidad.                       |
| **Calabobos**            | Fine drizzle          | Мелкая морось          | Lluvia muy fina que parece no mojar, pero penetra la ropa.    |
| **Sirimiri / Chirimiri** | Fine mist             | Сиримири               | Lluvia extremadamente fina, muy común en el norte de España.  |
| **Tormenta**             | Thunderstorm          | Гроза                  | Lluvia acompañada de rayos, relámpagos y truenos.             |
| **Aguacero**             | Downpour              | Сильный ливень         | Lluvia repentina, abundante и de corta duración.              |
| **Tromba de agua**       | Cloudburst            | Потоп / Сильный ливень | Una cantidad enorme de lluvia caída en muy poco tiempo.       |
| **Gota fría (DANA)**     | Torrential rain       | Холодная капля         | Fenómeno meteorológico con lluvias torrenciales y peligrosas. |
### Top 12 Verbos Irregulares (Presente de Indicativo)

| # | Infinitivo | Yo | Tú | Él/Ella/Usted | Nosotros | Ellos/Ellas/Ustedes | English | Русский |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| 1 | **Ser** | soy | eres | es | somos | son | To be (perm.) | Быть (пост.) |
| 2 | **Estar** | estoy | estás | está | estamos | están | To be (temp.) | Быть (врем.) |
| 3 | **Ir** | voy | vas | va | vamos | van | To go | Идти/Ехать |
| 4 | **Tener** | tengo | tienes | tiene | tenemos | tienen | To have | Иметь |
| 5 | **Hacer** | hago | haces | hace | hacemos | hacen | To do/make | Делать |
| 6 | **Poder** | puedo | puedes | puede | podemos | pueden | To be able | Мочь |
| 7 | **Querer** | quiero | quieres | quiere | queremos | quieren | To want/love | Хотеть/Любить |
| 8 | **Decir** | digo | dices | dice | decimos | dicen | To say/tell | Говорить/Сказать |
| 9 | **Saber** | sé | sabes | sabe | sabemos | saben | To know | Знать |
| 10 | **Poner** | pongo | pones | pone | ponemos | ponen | To put | Класть/Ставить |
| 11 | **Salir** | salgo | sales | sale | salimos | salen | To go out | Выходить |
| 12 | **Venir** | vengo | vienes | viene | venimos | vienen | To come | Приходить |


### Texto: 

Dicen que los españoles hablan (1) mucho y yo creo (2) que es (3) verdad. Por ejemplo, en el médico. Cuando la gente va al médico y está (4) en la sala de espera (5) empieza a ponerse nerviosa, mira a su alrededor, coge revistas, las vuelve (6) a dejar en su sitio y cuando por fin ve (7) a otra persona que le dirige la mirada, comienza la conversación: “Qué día tan feo hace (8) hoy, ¿no? – Sí, sí, es verdad. – Y usted, ¿por qué está aquí? – Pues ya ve, que con este tiempo una puede (9) siempre estar resfriada”. Lo mismo pasa en los ascensores. No se puede (10) compartir un ascensor sin hablar de algo; para empezar y por educación: “¿A qué piso va (11)? – Ah, al segundo, yo conozco (12) al señor Martínez, del segundo B”. Estoy seguro de que si vosotros venís (13) a España, enseguida os preguntarán de dónde venís (14), qué hacéis, dónde vivís (15), si os gusta España, etc.